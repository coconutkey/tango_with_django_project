...
def populate():
    ...
    python_pages = [
        {'title' : 'Official Python Tutorial', 'url' : 'http://docs.python.org/3/tutorial/', 'views' : 60},
        {'title' : 'How to Think like a Computer Scientist', 'url' : 'http://www.greenteapress.com/thinkpython/', 'views' : 30},
        {'title' : 'Learn Python in 10 Minutes', 'url' : 'http://www.korokithankis.net/tutorials/python/', 'views' : 15} ]
